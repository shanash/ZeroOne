...
public class L2d_Interaction_Base_Data : System.IDisposable
{
	...
	///	성공 타임라인 연출 ID
	///	</summary>
	public int reaction_timeline_id => _reaction_timeline_id;
	int _reaction_timeline_id;
	...
	public L2d_Interaction_Base_Data(Raw_L2d_Interaction_Base_Data raw_data)
	{
		...
		_reaction_timeline_id = raw_data.reaction_timeline_id;
	...
	public override string ToString()
	{
		...
		sb.AppendFormat("[reaction_timeline_id] = <color=yellow>{0}</color>", reaction_timeline_id).AppendLine();
