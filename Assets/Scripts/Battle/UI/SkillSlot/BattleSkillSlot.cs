    ...
    public void TouchEventCallback(TOUCH_RESULT_TYPE result, Func<bool, Rect> hole, object data)
    {
        switch (result)
        {
            ...
            case TOUCH_RESULT_TYPE.LONG_PRESS:
                ...
                Tooltip_Obj = GameObjectPoolManager.Instance.GetGameObject("Assets/AssetResources/Prefabs/UI/SkillInfoTooltip", transform.parent.parent.parent.parent);
                var tooltip = Tooltip_Obj.GetComponent<TooltipSkill>();
