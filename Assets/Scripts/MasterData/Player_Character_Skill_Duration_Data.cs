...
public class Player_Character_Skill_Duration_Data : System.IDisposable
{
	...
	///	지속성 스킬 효과 인덱스
	///	</summary>
	public int pc_skill_duration_id => _pc_skill_duration_id;
	int _pc_skill_duration_id;
	...
	///	반복 일회성 효과
	///	</summary>
	public int[] repeat_pc_onetime_ids => _repeat_pc_onetime_ids;
	int[] _repeat_pc_onetime_ids;
	...
	///	종료 일회성 효과
	///	</summary>
	public int[] finish_pc_onetime_ids => _finish_pc_onetime_ids;
	int[] _finish_pc_onetime_ids;
	...
	{
		_pc_skill_duration_id = raw_data.pc_skill_duration_id;
